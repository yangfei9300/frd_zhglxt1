  ...
  <div class="navbar" >
    ...
    <div class="right-menu">
      ...
      <template v-if="device!=='mobile'">
        ...
        <div style="height: 50px;font-weight: bold;color: blue;" class="right-menu-item"
        @click.stop="openSelExhAlert = true"
        >
          {{selExhInfo?selExhInfo.exhName:"请选择当前展会"}}
        </div>
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
         ...
         <!-- <el-dropdown-item @click.native="openSelExhAlert = true">
           <span>展会选择</span>
         </el-dropdown-item> -->
            ...
            <el-table v-loading="loading" :data="exh_listList"
             ...
             <el-table-column label="选择" align="center" prop="startTime" width="180">
               <template slot-scope="scope">
                 <el-radio v-model="selExhId" 
                 :label="scope.row.id">{{selExhId==scope.row.id?'已选择':''}}</el-radio>
               </template>
             </el-table-column>

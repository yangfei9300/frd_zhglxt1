...
<!--    <el-row style="background:#fff;padding:16px 16px 0;margin-bottom:32px;">
    ...
    <div class="roww center_center">
      <div style="font-weight: bold;margin-bottom: 20px;">企业招商类别类别</div>
    </div>
    <el-row :gutter="32">
      <el-col :xs="72" :sm="72" :lg="24">
        <div class="chart-wrapper">
          <bar-chart  v-if="isQiyeTypeShow" :xAxis_data="xAxis_data_t" :series_data="series_data_t" />
        </div>
      </el-col>
    </el-row>
    ...
    <div class="roww center_center">
      <div style="font-weight: bold;margin-bottom: 20px;">参展企业地区统计</div>
    </div>
    <el-row :gutter="32">
      <el-col :xs="72" :sm="72" :lg="24">
        <div class="chart-wrapper">
          <bar-chart  v-if="isDiquShow" :xAxis_data="xAxis_data" :series_data="series_data" />
        </div>
      </el-col>
    </el-row>

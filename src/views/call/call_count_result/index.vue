<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tongjiList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="剩余未联络数" align="center" prop="callWeilianluo" />
      <el-table-column label="意向强烈" align="center" prop="callQianglie" />
      <el-table-column label="意向一般" align="center" prop="callYiban" />
      <el-table-column label="无意向" align="center" prop="callWuyixiang" />
      <el-table-column label="失败" align="center" prop="callShibai" />
      <el-table-column label="合计" align="center" prop="callHeji" />
    </el-table>
     ...
     // 获取任务列表
      ...
      getList() {
        ...
        var data={
          ...
          resultcountcall(data).then(response => {

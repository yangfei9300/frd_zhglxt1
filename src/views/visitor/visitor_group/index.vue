<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['visitor:visitor_group:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="visitor_groupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="观众" align="center" prop="params.visitorName" />
      ...
      <el-table-column label="团队人数" align="center" prop="visitorTotal" />
      <el-table-column label="未场人数" align="center" prop="visitorTotal0" />
      <el-table-column label="已到场人数" align="center" prop="visitorTotal1" />
...
<script>
import { listVisitor_group, getVisitor_group, delVisitor_group,createvisitor_group,nogroupvisitor_info, addVisitor_group, updateVisitor_group } from "@/api/visitor/visitor_group";
...
importGroup
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listVisitor_group(this.queryParams).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('visitor/visitor_group/export', {
        ...this.queryParams

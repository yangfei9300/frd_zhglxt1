<template>
  <div class="navbar">
    <!-- 获取业务员 -->
    <el-dialog title="业务员" :visible.sync="openSelExhAlert" width="80%" append-to-body>
      <div>
        <el-row :gutter="24">
          <el-col :span="24"><div class="grid-content bg-purple div1">相关业务员</div></el-col>
        </el-row>
 ...
 -->
        <el-table v-loading="loading" :data="listExhibitor_contactList" highlight-current-row @selection-change="handleSelectionChange" @current-change="handleCurrentChange">
         ...
         <el-table-column label="性别" align="center" prop="contactGender">
          ...
          <el-table-column label="电话" align="center" prop="city" />
          ...
          <el-table-column label="其他联系方式" align="center" prop="contactTel" />
